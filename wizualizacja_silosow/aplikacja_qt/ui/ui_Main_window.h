...
"}"));
        ...
        temp_ico_al_2->setPixmap(QPixmap(QString::fromUtf8(":/ikona_warning_t\305\202o.png")));
        ...
        volume_ico_al_2->setPixmap(QPixmap(QString::fromUtf8(":/ikona_stop_t\305\202o.png")));
